...
*/
  //G4cout << "The Total Light is:  " << TotalLight << G4endl;
/*
  for (G4int i = 0; i < TotalLight ; i++) {
    //G4cout << i << G4endl;
    analysisManager->FillH1(4, dx);
    analysisManager->FillH1(5, dy);
    analysisManager->FillH2(0, dx, dy);
  }
*/
  // fill ntuple
  ...
  analysisManager->FillNtupleDColumn(2, TotalLight);
  analysisManager->FillNtupleDColumn(3, TotalDist);
