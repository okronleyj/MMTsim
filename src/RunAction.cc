...
RunAction::RunAction()
{
  ...
  //analysisManager->CreateH1("dx","dx", 1000, -10.0*cm, 10.0*cm);
  //analysisManager->CreateH1("dy","dy", 1000, -10.0*cm, 10.0*cm);

  //analysisManager->CreateH2("HeatMap","HeatMap", 50, -25.0*cm, 25.0*cm, 50, -25.0*cm, 25.0*cm);
